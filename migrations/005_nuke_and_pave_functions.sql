-- ============================================================
-- 005_nuke_and_pave_functions.sql
-- Totally rebuilds the SECURITY DEFINER functions from scratch
-- ensuring 0 warnings on the Supabase Security Advisor.
-- ============================================================

-- 1. DROP EVERYTHING to clear all cached signatures and privileges
...
-- 2. RECREATE FUNCTIONS WITH BLANK SEARCH PATH
...
-- handle_new_user is only invoked by trigger as postgres user

-- 5. RE-ATTACH TRIGGERS (Since CASCADE drops triggers relying on the function)
